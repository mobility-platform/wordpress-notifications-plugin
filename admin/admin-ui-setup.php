...
function mpn_register_settings() {
    ...
    add_settings_section(
        'mpn_general_settings_section',							// ID
        __('Mobility Platform Notifications General Settings', 'mobility-platform-notifications-plugin'),		// Title
        'mpn_general_settings_section_callback',					// Callback Function
        'mobility-platform-notifications-plugin'											// Page slug
    );
	
	// General Settings
    add_settings_field(
        'mpn_general_settings_field',							// ID
        __('General Settings', 'mobility-platform-notifications-plugin'),					// Title
        'mpn_general_settings_field_callback',					// Callback function
        'mobility-platform-notifications-plugin',											// Page slug
        'mpn_general_settings_section'							// Settings Section ID
    );
